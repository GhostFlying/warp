...
///
/// This is a local-only fallback for repositories whose repo metadata indexing fails or is
/// degraded. Complete local and remote repos should use [`find_skill_files_in_tree`] so the
